        ...
        <div class="row">
            <div class="img-holder">
                ...
                <div class="info-holder simple-info">
                    ...
                    <div><p>Silahkan isi data dibawah ini <br>Pastikan data yang Anda isi lengkap</p></div>
                </div>
            </div>
                        ...
                        <div class="row top-padding">
                                <div class="col-12 col-sm-12">
                                    <div class="form-button text-center" style="margin-top: -25px">
                                        <button id="btn-daftar" onclick="register();" class="ibtn btn-block" style="margin-top: -25px;">SIMPAN</button>
                                    </div>
                                </div>
                            </div>
                    </div>
...
function register(){
    ...
    if (validasi_input()==true){
        ...
        $.ajax({
            ...
            url : '<?=base_url("simpan/data_user_keluaga");?>', 
            data : formData,
            contentType : false,
            processData : false,
            dataType: "JSON",
